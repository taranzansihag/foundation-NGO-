...
<head>
        ...
        <title>pathik lok sewa samiti event and award</title>
 ...
 <body>
		...
		<div class="row" align="center">
		  ...
		  <li class="w3-dropdown-hover">
			...
			<div class="w3-dropdown-content w3-cyan w3-animate-zoom w3-card-4">
			  ...
			  <a href="general.php" class="w3-text-shadow">Leadership</a>
	...
	<div class="container">
		...
		<div class="col-sm-3">
		<br><br>
			<img src="img/pathik4.jpg" class="img-responsive w3-border w3-padding w3-round-xxlarge">
			<br><br>
			<img src="img/pathik_girls3.jpg" class="img-responsive w3-border w3-padding w3-round-xxlarge">
			<br>
		</div>
		
		<div class="col-sm-9">
			<div class="row w3-border-bottom w3-border-red">
			 <h1 class="w3-text-red w3-text-shadow">EVENT</h1>
		</div>
		<br><br><br>
			<table class="table">
		    <thead>
			  ...
			  $sn=0;
			   ...
			   while($r=mysql_fetch_array($rs)){
				   ...
				   ?>
					...
					<td><?=$sn?></td>
					<td><?=$r[1]?></td>
					<td><a href="admin/event/<?=$r[0]?>.jpg">download</a></td>
					</tr>
				   <?php
			   }
			  ?>
			  ...
			  <div class="row w3-border-bottom w3-border-red">
			 <h1 class="w3-text-red w3-text-shadow">AWARD</h1>
		</div>
		<br><br><br>
			<table class="table">
		    <thead>
			  ...
			  $sn=0;
			   ...
			   while($r=mysql_fetch_array($rs)){
				   ...
				   ?>
					...
					<td><?=$sn?></td>
					<td><?=$r[1]?></td>
					<td><a href="admin/award/<?=$r[0]?>.jpg">download</a></td>
					</tr>
				   <?php
			   }
			  ?>
