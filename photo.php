...
<head>
        ...
        <title>pathik lok sewa samiti photo</title>
		...
		<div class="row" align="center">
		  ...
		  <li><a href="contact.php" class="w3-text-shadow">Contact us</a></li>
			...
			<div class="well well-sm" align="center">
				<b class="w3-text-red w3-text-shadow">A L L  &nbsp&nbsp&nbsp&nbsp P H O T O ' S</b>
			</div> 
			<?php
			
				include("database.php");
				$rs = mysql_query("select * from gallary");
				while($r = mysql_fetch_array($rs)){
					?>
					
					<div class="col-sm-4 w3-card-4">
					<br>
						<img src="admin/gallary/<?=$r[0]?>.jpg" class="img-responsive w3-border w3-padding w3-round-xxlarge" style="height:400"><br>
						<b class="w3-text-blue"><?=$r[1]?></b>
						<br><br>
					</div>
			...
			<div class="row">
			<div class="well well-sm" align="center">
				<b class="w3-text-red w3-text-shadow">A L L  &nbsp&nbsp&nbsp&nbsp E V E N T &nbsp&nbsp&nbsp&nbsp P H O T O ' S</b>
			</div> 
			<?php
				...
				while($r = mysql_fetch_array($rs)){
					...
					<div class="col-sm-4 w3-card-4">
					<br>
						<img src="admin/event/<?=$r[0]?>.jpg" class="img-responsive w3-border w3-padding w3-round-xxlarge"  style="height:400"><br>
						<b class="w3-text-blue"><?=$r[1]?></b>
						<br><br>
					</div>
			...
			<div class="row">
			<div class="well well-sm" align="center">
				<b class="w3-text-red w3-text-shadow">A L L  &nbsp&nbsp&nbsp&nbsp A W A R D S &nbsp&nbsp&nbsp&nbsp P H O T O ' S</b>
			</div> 
			<?php
				...
				while($r = mysql_fetch_array($rs)){
					...
					<div class="col-sm-4 w3-card-4">
					<br>
						<img src="admin/award/<?=$r[0]?>.jpg" class="img-responsive w3-boredr w3-padding w3-round-xxlarge"  style="height:400"><br>
						<b class="w3-text-blue"><?=$r[1]?></b>
						<br><br>
					</div>
