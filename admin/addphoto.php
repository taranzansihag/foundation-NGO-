	 ...
	 <div class="container-fluid">
	   ...
	   ?>
			...
			<div class="well well-sm" align="center">
				<b class="w3-text-red">Add Photo pannel</b>
			</div>
			<?php
					if(isset($_GET["not"])){
				...
				<form enctype="multipart/form-data" action="addphotos.php" method="POST">
			...
			<br>
				<label class="w3-text-green">photo related news : </label><textarea name="news" row="3" coloum="100" required="required" class="form-control"></textarea><br>
