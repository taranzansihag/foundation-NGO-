	 ...
	 <div class="container-fluid">
	   ...
	   ?>
			...
			<div class="well well-sm" align="center">
				<b class="w3-text-red">On Going Work</b>
			</div>
			<?php
					if(isset($_GET["not"])){
				...
				<form enctype="multipart/form-data" action="addwork.php" method="POST">
				
				<br>
			
			
			<br>
				<label class="w3-text-green">Our work : </label><textarea name="news" row="10" placeholder="this means on going work " coloum="150" required="required" class="form-control"></textarea><br>
