			...
			?>
				...
				?>
				 <tr class="success">
								<td><?=$sn?></td>
								<td><?=$r[1]?></td>
								<td><a href="news/<?=$r[0]?>.pdf" width="100">download</a></td>
								<td><a href="newsdelete.php?name=<?=$r[1]?>"><img src="img/delete.png" width="20" height="20"></a></td>
							</tr>	
					<?php
				...
				?>
						...
						<button class="btn btn-success"><a href="addnewsform.php">Add new news</a></button>
