			...
			?>
				...
				?>
				 <tr class="success">
								...
								<td><?=$r[3]?></td>
								<td><?=$r[4]?></td>
								<td><a href="deletebranch.php?name=<?=$r[0]?>"><img src="img/delete.png" width="20" height="20"></a></td>
							</tr>	
					<?php
				...
				?>
						...
						<button class="btn btn-success"><a href="branchform.php">Add new branch</a></button>
