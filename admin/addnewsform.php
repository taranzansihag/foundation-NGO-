	 ...
	 <div class="container-fluid">
	   ...
	   ?>
			...
			<div class="well well-sm" align="center">
				<b class="w3-text-red">Add News Pannel</b>
			</div>
				<?php
					if(isset($_GET["not"])){
							   echo '<b class="w3-text-red">'."sorry ! news not added".'</b>';
				}
				?>
			...
			<label class="w3-text-green">Choose News :</label>
			
			<input class="form-control" type="file" name="photo" placeholder="if you have a pdf file then choos otherwise ignore">
			
			<br>
				<label class="w3-text-green">news type: </label><textarea name="news" row="3" coloum="100" required="required" class="form-control"></textarea><br>
