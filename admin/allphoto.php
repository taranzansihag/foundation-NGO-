			...
			?>
				...
				?>
				 <tr class="success">
								<td><?=$sn?></td>
								<td><?=$r[1]?></td>
								<td><img src="gallary/<?=$r[0]?>.jpg" class="img-responsive" width="100"></td>
								<td><a href="photodelete.php?name=<?=$sn?>"><img src="img/delete.png" width="20" height="20"></a></td>
							</tr>	
					<?php
				...
				?>
						...
						<button class="btn btn-success"><a href="addphoto.php">Add new photo</a></button>
