...
<head>
        ...
        <title>pathik lok sewa samiti general</title>
	 ...
	 <div class="container">
	   <div class="responsive">
			...
			<div class="col-sm-3">
					...
					<br><br>	<br>
				 <button class="w3-btn w3-purple" id="annual_letter"  onClick="change('annual_letter')"><b>Letter From Bill</b></button><br><br><br>
				 <button class="w3-btn w3-purple" id="report"  onClick="change('report')"><b>Foundation fact sheet</b></button><br><br><br>
                 <button class="w3-btn w3-purple" id="press_room"  onClick="change('press_room')"><b>History</b></button><br><br><br>
				 <button class="w3-btn w3-purple" id="leader"  onClick="change('leader')"><b>Leadership</b></button><br><br><br>
				 <button class="w3-btn w3-purple" id="career"  onClick="change('career')"><b>Regional Office</b></button><br><br><br>
			...
			<div class="col-sm-9">
				...
				<div id="reports">
					<img src="img/pathik2.jpg" class="img-responsive w3-border we-padding w3-round-xxlarge">
					<p>	<br><br>
				...
				<div id="press_rooms">
				<img src="img/pathik_girls.jpg" class="img-responsive w3-border we-padding w3-round-xxlarge">
					<br><br>
					<p>Pathik lok sewa samiti is a non-governmental organization (NGO) working in sawai madhaopur (Raj.), India. 
					The registration number of the organization is: 120/SWM/2004-2005. 
					Established in the year 2004?, pathik lok sewa samiti works in the save girls,
				...
				<div id="leaders">
				<img src="img/pathik_girls1.jpg" class="img-responsive w3-border we-padding w3-round-xxlarge">
					<br><br>
				<p>
				...
				<h3><b class="w3-text-shadow w3-text-blue">
					head office : C/o mukesh meena , 5 , new post office colony , behind of police line , Sawai Madhopur (Raj.) 322001
					<br><br>
					Email Id: pathikloksewa@gmail.com , 9983678080 , 9413378080</b></h3><br>
					<b>. . . . . . . . . . . . . . . . . . . . . </b><br>
					<h3><b class="w3-text-shadow w3-text-blue">
					Contact person : Mr. Mukesh Meena <br>
					Mobile No. : 9983678080<br>
					Email Id : mukeshsiit@yahoo.com<br>
					Address : H.No. 5, ward no. 04 , Meena colony , Sawai Madhopur 322001
					</b></h3>
				</div>
